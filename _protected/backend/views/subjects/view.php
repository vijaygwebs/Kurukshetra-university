    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{edit-subject}{delete-subject}',
                'buttons' => [
                    ...
                    'delete-subject' =>function ($url, $model, $key) {
                        $options = array_merge([
                            'title' => Yii::t('yii', 'Delete subject'),
                            'aria-label' => Yii::t('yii', 'Delete subject'),
                            'data-pjax' => '0',
                        ], []);
                        return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['view','id'=>$model->id], $options);
                    },
